...
Feature: Tester l'achat sur la plateforme SHOPTOOLSQA
  ...
  Scenario:Tester l'achat sur la plateforme SHOPTOOLSQA
    ...
    And Je remplis les champs prénom "Raissi" et nom " Zied" et pays "Tunisia"et l’adresse " LA sokra 2043"et ville "La Marsa " et etat "achat en ligne"  et code postale "1003" et numéro de téléphone "+21658999862" et l’adresse mail "raissi.zied0108@gmail.com"""
